...
-- Perhitungan penerimaan mengikuti semua payment milik penjualan yang sudah
-- berstatus paid. Pembayaran tunai lama tidak selalu memiliki provider_status,
-- tetapi tetap sah karena penjualannya sudah selesai.
